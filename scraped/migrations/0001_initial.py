    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scraped.ecommercestore')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_local_store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scraped.localstore')),
                ('parent_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scraped.product')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('parent_product', 'parent_local_store', 'last_scrape_end'), name='Unique ProductLocalData'),
        ),
    ]
